...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/".basename($fnew);                      // the path to Canteen the upload image
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update restaurant set c_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew' where rs_id='$_GET[res_upd]' ";  // Canteen the submited data ino the database :images												mysqli_query($db, $sql); 
													mysqli_query($db, $sql); 
...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <button class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse" data-target="#mainNavbarCollapse">&#9776;</button>
                    <a class="navbar-brand" href="dashboard.php"> <img class="img-rounded" src="images/Ubieats_long.png" alt="" height= "50" width="150"> </a>
                </div>
                <!-- End Logo -->
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Canteen</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allrestraunt.php">All Canteens</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_restraunt.php">Add Canteen</a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © Ubieats. 2020 All rights reserved. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>

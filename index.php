                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose a Canteen</h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Eat or Take out</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">The easiest way to order your favourite food from ubisoft canteen</p>
                </div>
                <div class="row">
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We've got your covered with more than 50 menus from Ubisoft canteens online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Eat Or Take Out</h3>
                                <p>Get your food Ready to eat! And enjoy your meal!</p>
                            </div>
                        </div>
                    </div>
                </div>
